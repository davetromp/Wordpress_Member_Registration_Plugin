	...
	<div class="mbrreg-admin-columns">
		...
		<div class="mbrreg-admin-column mbrreg-admin-column-wide">
			<div class="mbrreg-admin-card">
								...
								<tr data-field-id="<?php echo esc_attr($field->id); ?>">
									...
									<td>
										<?php if ($field->is_admin_only): ?>
											<span class="dashicons dashicons-lock" style="color: #d63638;"
												title="<?php esc_attr_e('Admin only - users cannot edit', 'member-registration-plugin'); ?>"></span>
										<?php else: ?>
											<span class="dashicons dashicons-unlock" style="color: #999;"
												title="<?php esc_attr_e('Editable by users', 'member-registration-plugin'); ?>"></span>
										<?php endif; ?>
									</td>
									<td>
										...
										<button type="button" class="button button-small button-link-delete mbrreg-delete-field"
											data-field-id="<?php echo esc_attr($field->id); ?>">
				...
				<?php else: ?>
					<p class="mbrreg-empty-message">
						<?php esc_html_e('No custom fields have been created yet.', 'member-registration-plugin'); ?></p>
				<?php endif; ?>
			</div>
		</div>
			...
			<div class="mbrreg-admin-card">
				...
				<form id="mbrreg-add-field-form" class="mbrreg-admin-form">
					<div class="mbrreg-form-row">
						<label
							for="field_name"><?php esc_html_e('Field Name', 'member-registration-plugin'); ?></label>
						<input type="text" name="field_name" id="field_name" required pattern="[a-z0-9_]+"
							title="<?php esc_attr_e('Lowercase letters, numbers, and underscores only', 'member-registration-plugin'); ?>">
						<p class="description">
							<?php esc_html_e('Unique identifier. Lowercase letters, numbers, and underscores only.', 'member-registration-plugin'); ?>
						</p>
					</div>

					<div class="mbrreg-form-row">
						<label
							for="field_label"><?php esc_html_e('Field Label', 'member-registration-plugin'); ?></label>
						<input type="text" name="field_label" id="field_label" required>
						<p class="description">
							<?php esc_html_e('The label displayed to users.', 'member-registration-plugin'); ?></p>
					</div>

					<div class="mbrreg-form-row">
						<label
							for="field_type"><?php esc_html_e('Field Type', 'member-registration-plugin'); ?></label>
					...
					<div class="mbrreg-form-row mbrreg-field-options-row" style="display: none;">
						<label
							for="field_options"><?php esc_html_e('Options', 'member-registration-plugin'); ?></label>
						<textarea name="field_options" id="field_options" rows="4"></textarea>
						<p class="description">
							<?php esc_html_e('Enter one option per line.', 'member-registration-plugin'); ?></p>
					</div>

					<div class="mbrreg-form-row">
						<label
							for="field_order"><?php esc_html_e('Display Order', 'member-registration-plugin'); ?></label>
						<input type="number" name="field_order" id="field_order" value="0" min="0">
						<p class="description">
							<?php esc_html_e('Lower numbers display first.', 'member-registration-plugin'); ?></p>
					</div>
					...
					<div class="mbrreg-form-row">
						...
						<p class="description">
							<?php esc_html_e('If checked, only administrators can view and edit this field. Users will see the value but cannot change it.', 'member-registration-plugin'); ?>
						</p>
					</div>

					<div class="mbrreg-form-row">
						<button type="submit"
							class="button button-primary"><?php esc_html_e('Add Field', 'member-registration-plugin'); ?></button>
		...
		<div class="mbrreg-modal-content">
			...
			<div class="mbrreg-modal-body">
				<form id="mbrreg-edit-field-form" class="mbrreg-admin-form">
					...
					<div class="mbrreg-form-row">
						<label
							for="edit_field_label"><?php esc_html_e('Field Label', 'member-registration-plugin'); ?></label>
						<input type="text" name="field_label" id="edit_field_label" required>
					</div>

					<div class="mbrreg-form-row">
						<label
							for="edit_field_type"><?php esc_html_e('Field Type', 'member-registration-plugin'); ?></label>
					...
					<div class="mbrreg-form-row mbrreg-edit-field-options-row" style="display: none;">
						<label
							for="edit_field_options"><?php esc_html_e('Options', 'member-registration-plugin'); ?></label>
					...
					<div class="mbrreg-form-row">
						<label
							for="edit_field_order"><?php esc_html_e('Display Order', 'member-registration-plugin'); ?></label>
					...
					<div class="mbrreg-form-row">
						<button type="submit"
							class="button button-primary"><?php esc_html_e('Update Field', 'member-registration-plugin'); ?></button>
						<button type="button"
							class="button mbrreg-modal-close"><?php esc_html_e('Cancel', 'member-registration-plugin'); ?></button>
						<span class="spinner"></span>
					</div>
				</form>
			</div>
