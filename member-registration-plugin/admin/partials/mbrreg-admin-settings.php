...
<div class="wrap mbrreg-admin-wrap">
	...
	<form method="post" action="options.php">
			...
			<table class="form-table">
				<tr>
					...
					<td>
						...
						<p class="description">
							<?php esc_html_e('When disabled, the registration form will not be shown.', 'member-registration-plugin'); ?>
						</p>
					</td>
				</tr>
				<tr>
					...
					<td>
						...
						<p class="description">
							<?php esc_html_e('Useful for parents registering multiple children or family members.', 'member-registration-plugin'); ?>
						</p>
					</td>
				</tr>
				<tr>
					<th scope="row">
						<label
							for="mbrreg_registration_page_id"><?php esc_html_e('Member Area Page', 'member-registration-plugin'); ?></label>
					</th>
					<td>
						<select name="mbrreg_registration_page_id" id="mbrreg_registration_page_id">
							<option value="0"><?php esc_html_e('— Select —', 'member-registration-plugin'); ?>
							</option>
						...
						<p class="description">
							<?php esc_html_e('The page containing the [mbrreg_member_area] shortcode.', 'member-registration-plugin'); ?>
						</p>
					</td>
				</tr>
				<tr>
					<th scope="row">
						<label
							for="mbrreg_login_redirect_page"><?php esc_html_e('Login Redirect Page', 'member-registration-plugin'); ?></label>
					</th>
					<td>
						...
						<p class="description">
							<?php esc_html_e('Where to redirect members after successful login.', 'member-registration-plugin'); ?>
						</p>
					</td>
				</tr>
			</table>
		...
		<div class="mbrreg-settings-section">
			...
			<table class="form-table">
				<tr>
					<th scope="row">
						<label
							for="mbrreg_date_format"><?php esc_html_e('Date Format', 'member-registration-plugin'); ?></label>
					</th>
					<td>
						...
						<p class="description">
							<?php esc_html_e('Choose how dates are displayed throughout the plugin.', 'member-registration-plugin'); ?>
						</p>
					</td>
				</tr>
			</table>
		...
		<div class="mbrreg-settings-section">
			...
			<p class="description">
				<?php esc_html_e('Select which default fields should be required during registration and profile updates. Additional fields can be configured in the Custom Fields section.', 'member-registration-plugin'); ?>
			</p>
			<table class="form-table">
				<tr>
		...
		<div class="mbrreg-settings-section">
			...
			<table class="form-table">
				<tr>
					<th scope="row">
						<label
							for="mbrreg_email_from_name"><?php esc_html_e('From Name', 'member-registration-plugin'); ?></label>
					</th>
					<td>
						<input type="text" name="mbrreg_email_from_name" id="mbrreg_email_from_name"
							value="<?php echo esc_attr(get_option('mbrreg_email_from_name', get_bloginfo('name'))); ?>"
							class="regular-text">
						<p class="description">
							<?php esc_html_e('The name that will appear in the "From" field of emails.', 'member-registration-plugin'); ?>
						</p>
					</td>
				</tr>
				<tr>
					<th scope="row">
						<label
							for="mbrreg_email_from_address"><?php esc_html_e('From Email', 'member-registration-plugin'); ?></label>
					</th>
					<td>
						<input type="email" name="mbrreg_email_from_address" id="mbrreg_email_from_address"
							value="<?php echo esc_attr(get_option('mbrreg_email_from_address', get_option('admin_email'))); ?>"
							class="regular-text">
						<p class="description">
							<?php esc_html_e('The email address that will appear in the "From" field.', 'member-registration-plugin'); ?>
						</p>
					</td>
				</tr>
			</table>
		...
		<div class="mbrreg-settings-section">
			...
			<table class="form-table mbrreg-shortcodes-table">
				<tr>
					...
					<td><?php esc_html_e('Complete member area with login, registration, and dashboard.', 'member-registration-plugin'); ?>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><?php esc_html_e('Member dashboard (for logged-in members only).', 'member-registration-plugin'); ?>
					</td>
				</tr>
			</table>
		</div>
