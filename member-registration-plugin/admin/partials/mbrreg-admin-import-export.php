	...
	<div class="mbrreg-admin-sections">
		...
		<div class="mbrreg-admin-section">
			...
			<div class="mbrreg-import-instructions">
				...
				<p><?php esc_html_e('Your CSV file should have the following columns in order:', 'member-registration-plugin'); ?>
				</p>
				<ol>
					<li><strong><?php esc_html_e('Email', 'member-registration-plugin'); ?></strong>
						(<?php esc_html_e('required', 'member-registration-plugin'); ?>)</li>
				...
				<p><strong><?php esc_html_e('Note:', 'member-registration-plugin'); ?></strong>
					<?php esc_html_e('The first row should contain column headers and will be skipped during import.', 'member-registration-plugin'); ?>
				</p>
			</div>
			...
			<form id="mbrreg-import-form" method="post" enctype="multipart/form-data" class="mbrreg-admin-form">
				<table class="form-table">
					<tr>
						<th scope="row">
							<label
								for="csv_file"><?php esc_html_e('CSV File', 'member-registration-plugin'); ?></label>
						</th>
						<td>
							<input type="file" name="csv_file" id="csv_file" accept=".csv" required>
							<p class="description">
								<?php esc_html_e('Select a CSV file to import.', 'member-registration-plugin'); ?></p>
						</td>
					</tr>
				</table>
			...
			<div class="mbrreg-sample-csv">
				...
				<p><?php esc_html_e('Download a sample CSV file with the correct format:', 'member-registration-plugin'); ?>
				</p>
		...
		<div class="mbrreg-admin-section">
			...
			<form method="get" action="<?php echo esc_url(admin_url('admin.php')); ?>" class="mbrreg-admin-form">
				...
				<table class="form-table">
					<tr>
						<th scope="row">
							<label
								for="export_status"><?php esc_html_e('Member Status', 'member-registration-plugin'); ?></label>
						</th>
						<td>
							<select name="status" id="export_status">
								<option value=""><?php esc_html_e('All Members', 'member-registration-plugin'); ?>
								</option>
								<option value="active">
									<?php esc_html_e('Active Only', 'member-registration-plugin'); ?></option>
								<option value="inactive">
									<?php esc_html_e('Inactive Only', 'member-registration-plugin'); ?></option>
								<option value="pending">
									<?php esc_html_e('Pending Only', 'member-registration-plugin'); ?></option>
							</select>
						</td>
					</tr>
				</table>
			...
			<div class="mbrreg-export-info">
				...
				<ul>
					...
					<li><?php esc_html_e('Status, Admin Status, Registration Date', 'member-registration-plugin'); ?>
					</li>
